...
class Fetchr_Shiphappy_Model_Accounttype
{
    public function toOptionArray()
    {
        return array(
            array('value'=>'live', 'label'=>Mage::helper('shiphappy')->__('Live')),
            array('value'=>'staging', 'label'=>Mage::helper('shiphappy')->__('Staging')),
        );
    }
}